    ...
    modes: [
      {
        tag: "RANKED",
        title: "BOUNTY",
        desc: "A company posts a real optimization problem with a prize. Developers compete for free — no entry fee. The best solution wins the reward. The company gets better code, you get paid.",
        details: [
      ...
      },
      {
        tag: "RANKED // MAX",
        title: "BOUNTY_WAR",
        desc: "A sponsor posts a guaranteed prize, and players can optionally add entry fees to grow the pool even bigger. Think of it as a tournament with a guaranteed minimum — the more players, the bigger the reward.",
        details: [
      ...
      },
      {
        tag: "FREE",
        title: "TRAINING",
        desc: "Practice optimization with zero risk. No entry fee, no ranking. Same challenges as the real arenas. Perfect for sharpening your skills before competing.",
        details: [
